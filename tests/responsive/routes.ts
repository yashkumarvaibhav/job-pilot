...
export const REGISTERED_PAGES: RegisteredPage[] = [
  ...
  { file: "(auth)/verify/page.tsx", path: "/verify?token=synthetic-invalid-token", access: "signed-out" },
  { file: "(auth)/reset-password/page.tsx", path: "/reset-password?token=synthetic-invalid-token", access: "signed-out" },
