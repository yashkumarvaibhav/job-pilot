...
export const LOGIN_FAILED_MESSAGE = "Username or password not recognised";
export const REQUEST_FAILED_MESSAGE = "Something went wrong. Try again.";
export const ACCOUNT_SECURITY_UNAVAILABLE_MESSAGE =
  "Account security is temporarily unavailable. Try again later.";
export const TOTP_CONFIRM_FAILED_MESSAGE =
  "That authenticator code could not be confirmed.";
export const TOTP_ALREADY_ENABLED_MESSAGE = "Authenticator is already enabled.";
export const PASSWORD_RESET_FAILED_MESSAGE = "We could not reset that account.";
export const PASSWORD_RESET_COMPLETE_MESSAGE =
  "Password reset. Sign in with your new password.";
export const PASSWORD_CHANGE_FAILED_MESSAGE =
  "We could not change the password. Check all three fields.";
export const PASSWORD_CHANGE_COMPLETE_MESSAGE =
  "Password changed. Sign in with your new password.";
export const TOTP_SKIPPED_WARNING =
