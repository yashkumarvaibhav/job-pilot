...
const TENANT_ROUTE_FILES = [
  ...
  "documents/route.ts",
  "enrollments/[id]/stop/route.ts",
  "export/route.ts",
  "gmail/[id]/default/route.ts",
  "gmail/[id]/disconnect/route.ts",
  "gmail/[id]/sync/route.ts",
  "gmail/[id]/route.ts",
  "gmail/accounts/route.ts",
  "gmail/callback/route.ts",
  "gmail/connect/route.ts",
  "inbox/[id]/classify/route.ts",
  "inbox/[id]/confirm-match/route.ts",
  "inbox/[id]/relink/route.ts",
  "inbox/import/search/route.ts",
  "inbox/import/route.ts",
  "inbox/route.ts",
  "import/route.ts",
